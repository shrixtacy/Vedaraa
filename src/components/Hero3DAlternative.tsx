        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen">
          ...
          <ScrollAnimationWrapper animationType="slideRight" duration={1}>
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 border border-primary/30 rounded-full bg-primary/5">
                ...
                <span className="text-sm text-primary uppercase tracking-wider">Premium Furniture</span>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground/80 text-lg md:text-xl leading-relaxed max-w-xl">
                  Explore our meticulously crafted furniture designs. 
                  Each piece is handcrafted with premium materials to transform your space into a masterpiece.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-primary font-heading mb-1">Premium Experience</h3>
                    <p className="text-muted-foreground text-sm">
                      Handcrafted luxury furniture designed for discerning clients
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Finest materials and attention to every detail
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
          ...
          <ScrollAnimationWrapper animationType="slideLeft" duration={1} delay={0.2}>
            <div className="relative h-[600px] lg:h-[700px]">
              ...
              {/* 3D Model Container - No box, just the model */}
...
export default Hero3DAlternative;